...
## 罗瑶光先生
##### 作为德塔开源创始人，一直专注于数据智能领域十余年， 抱着学徒的心态，作者先后游学中国，印度，美国并广泛的就读工学，工程学和理学的计算机硕士和研究生课程。并进行4年海外信息技术工作实践。通过大量计算机日志笔记和学习手稿反复札记思想，罗瑶光先生先后设计了多篇数据优化和无缝集成论文并进行实践，率先提出<<VPCS 微分催化和类人DNA数据进化计算理念>>，并进行相关开源项目进行反复持续和详细论证。
##### 罗瑶光先生个人作品, 咨讯履历集：
